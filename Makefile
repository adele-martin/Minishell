...
#    Updated: 2024/09/06 15:09:10 by ademarti         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
#FLAGS = -Wall -Werror -Wextra -g3 -I/usr/local/opt/readline/include -g -O0 -fsanitize=address,undefined
...
#cc $(FLAGS) $(OBJECTS) -o $@ -lreadline -L./src/Libft_extended -L/usr/local/opt/readline/lib -lft -L.
$(LIBFT):
